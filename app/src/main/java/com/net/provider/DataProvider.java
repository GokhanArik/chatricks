...
public class DataProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI_MESSAGES = Uri.parse("content://com.net.provider/messages");
	public static final Uri CONTENT_URI_PROFILE = Uri.parse("content://com.net.provider/profile");
	...
	private static final int CONTACTS_URI = 5;
	
	private static final UriMatcher uriMatcher;
	static {
		uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
		uriMatcher.addURI("com.net.provider", "messages", MESSAGES_ALLROWS);
		uriMatcher.addURI("com.net.provider", "messages/#", MESSAGES_SINGLE_ROW);
		uriMatcher.addURI("com.net.provider", "profile", PROFILE_ALLROWS);
		uriMatcher.addURI("com.net.provider", "profile/#", PROFILE_SINGLE_ROW);
		uriMatcher.addURI("com.android.contacts", "contacts", CONTACTS_URI);	
